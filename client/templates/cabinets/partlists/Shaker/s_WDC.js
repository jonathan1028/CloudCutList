S_WallDiagonalCorner = function(cabinet, orderId, cabinetId){
	      ///////////Face Frame Stile
        ...
        ///////////Door Rails
        width = 17 - 3.625;  // Subtract 4" for width of 2 stiles, add .50 for the tongues, subtract .125 for 1/16" offset on sides
        height = 2;
        qty = (width)/12;
        ...
        ///////////Door Panel
        width = 17 - 3.625;   // Subtract 4" for width of 2 stiles, add .50 for the tongues, subtract .125 for 1/16" offset of door from sides
        height = cabinet.height - 3.625; // Subtract 4" for width of 2 stiles, add .50 for the tongues, subtract .125 for 1/16" offset of door from sides
        ...
        ///////////Side Wall
        width = cabinet.depth - .75 + .75; //+ .75" to account for diagonal bevel
        ...
        ///////////Diagonal Back Wall
        width = 17; //Matching to face width, may need to be altered
        height = cabinet.height;
        qty = ((width * height)/144)/32;
        ...
        var SideWall = {
          ...
          cabinetName: cabinet.name,
          name: 'sidewall',
          description: 'Diagonal Back Wall',
          material: '5/8" 1SUV Birch',
          width: width,
          height: height,
          depth: 0.625,
        ...
        ///////////Back Panel
        width = 12 - 1.125;
        height = cabinet.height - 2;    //Sub 1.25" for space between bottom/top panel and end of cabinet, sub 1.25" for thickness of bottom/top panel, add back .5" for depth of dados.
        qty = ((width * height)/144)/32;
