FFWallDoubleDoor = function(cabinet, orderId, cabinetId){
	      ///////////Face Frame Stile
        ...
        Meteor.call('partInsert', faceframerail, function(error, partId) {
         ...
         ///////////Door Panel
        width = (cabinet.width - .125)/2; // subtract .125 for 1/16" offset on sides
        height = cabinet.height - .125;   // Subract .125 for 1/16" offest from top/bottom
